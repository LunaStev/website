...
export default function ImagePage() {
    ...
    return (
        <div className={themeClass}>
            <Head>
                <title>{t('imageTitle')} - {t('metaTitle')}</title>
                <meta name="description" content={t('imageDescription')} />
                <meta property="og:title" content={`${t('imageTitle')} - ${t('metaTitle')}`} />
                <meta property="og:description" content={t('imageDescription')} />
                <link rel="canonical" href="https://lunastev.org/tools/image" />
            </Head>
            ...
            <main className="main-content">
                <Container>
                    <div className="text-center mb-4">
                        ...
                        <h1 className="display-5 mb-3">📷 {t('imageTitle')}</h1>
                        <p className="lead text-muted">{t('imageDescription')}</p>
                    </div>
