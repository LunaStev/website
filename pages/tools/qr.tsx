...
export default function QRPage() {
    ...
    return (
        <div className={themeClass}>
            <Head>
                <title>{t('qrTitle')} - {t('metaTitle')}</title>
                <meta name="description" content={t('qrDescription')} />
            ...
            <main className="main-content">
                <Container>
                    <div className="text-center mb-4">
                        ...
                        <h1 className="display-5 mb-3">📱 {t('qrTitle')}</h1>
                        <p className="lead text-muted">{t('qrDescription')}</p>
                    </div>
