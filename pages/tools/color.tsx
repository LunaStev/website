...
export default function ColorPage() {
    ...
    return (
        <div className={themeClass}>
            <Head>
                <title>{t('colorTitle')} - {t('metaTitle')}</title>
                <meta name="description" content={t('colorDescription')} />
            ...
            <main className="main-content">
                <Container>
                    <div className="text-center mb-4">
                        ...
                        <h1 className="display-5 mb-3">🎨 {t('colorTitle')}</h1>
                        <p className="lead text-muted">{t('colorDescription')}</p>
                    </div>
