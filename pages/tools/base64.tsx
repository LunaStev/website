...
export default function Base64Page() {
    ...
    return (
        <div className={themeClass}>
            <Head>
                <title>{t('base64Title')} - {t('metaTitle')}</title>
                <meta name="description" content={t('base64Description')} />
            ...
            <main className="main-content">
                <Container>
                    <div className="text-center mb-4">
                        ...
                        <h1 className="display-5 mb-3">🔄 {t('base64Title')}</h1>
                        <p className="lead text-muted">{t('base64Description')}</p>
                    </div>
